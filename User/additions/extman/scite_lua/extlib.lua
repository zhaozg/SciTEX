...
MarkerType = class(function(self,idx,typ,fore,back)
	...
	if fore then editor.MarkerFore[idx] = colour_parse(fore) end
...
local function init_breakpoints()
	if not initialized then
		active_cursor = MarkerType(active_cursor_idx,SC_MARK_BACKGROUND,nil,'lightgreen')
		signalled_cursor = MarkerType(signalled_cursor_idx,SC_MARK_BACKGROUND,nil,'pink')
