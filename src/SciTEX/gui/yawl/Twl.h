...
public:
  ...
  bool child_messages()
  {
    return m_child_messages;
  }
  void view_child_messages(bool yesno)
  {
    m_child_messages = yesno;
  }
...
//-----------Event Handling-------------------
  ...
  virtual bool activate(bool yes)
  {
    return true;
  }
...
public:
  ...
  void set_form(TEventWindow *form)
  {
    m_form = form;
  }
...
public:
  ...
  void set_colour(float r, float g, float b);
  long get_colour() const
  {
    return m_colour;
  }
  TEventWindow *parent() const
  {
    return m_parent;
  }
  void parent(TEventWindow *ew)
  {
    m_parent = ew;
  }
  void data(void *data)
